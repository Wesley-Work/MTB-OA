  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '在线用户',
        icon: 'user-visible',
        permissions: ['account.online.get-list'],
        ...
        children: [
          {
            key: 'LendList',
            label: '借出列表',
            permissions: ['equipment.record.get-list'],
        ...
        children: [
          {
            key: 'EqList',
            label: '设备列表',
            permissions: ['equipment.manage.get-list'],
        ...
        children: [
          {
            key: 'AccountManage',
            label: '账号管理',
            permissions: ['account.manage.get-list'],
        ...
        children: [
          {
            ...
            label: '人员列表',
            permissions: ['hikvision.operation.sync-user'],
          ...
          },
          {
            key: 'FaceAccessAsync',
            label: '异步任务',
            permissions: ['hikvision.operation.get-async'],
        ...
        children: [
          {
            key: 'SystemLog',
            label: '系统日志',
            permissions: ['log.manage.system'],
            component: () => import('@pages/log/system.vue'),
          },
          {
            key: 'BehaviorLog',
            label: '行为日志',
            permissions: ['log.manage.behavior'],
            component: () => import('@pages/log/user.vue'),
          },
          {
            key: 'RequestLog',
            label: '请求日志',
            permissions: ['log.manage.request'],
