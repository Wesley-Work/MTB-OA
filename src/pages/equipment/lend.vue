      ...
      <div id="lendpage">
        <div style="display: flex; flex-direction: row; justify-content: space-between">
          ...
          <div style="min-width: 35%">
            ...
            >
              <t-checkbox v-model="formData.help" class="helpotheruserlend_box" @click.end="formData.guest = false"
                >帮借/转借</t-checkbox
              >
            ...
            >
              <t-checkbox v-model="formData.guest" class="helpotheruserlend_box" @click.end="formData.help = false"
                >访客借出</t-checkbox
              >
              <div style="display: flex">
                <t-input
