            ...
            <t-space direction="vertical">
              <t-space>
                ...
                <t-input-number
                  ...
                  "
                  @click="($data.number_choose_backup = $data.number_choose), ($data.number_choose = 4)"
                ></t-input-number>
              </t-space>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px">
              ...
              <t-space direction="vertical">
                <t-space>
                  <t-button
                    variant="outline"
                    :class="{ 'wesley-hover': number_choose && Data.SelectGroupData.length > 1 == 1 }"
                  ...
                  <t-button
                    variant="outline"
                    :class="{ 'wesley-hover': number_choose && Data.SelectGroupData.length > 2 == 2 }"
                  ...
                  <t-button
                    variant="outline"
                    :class="{ 'wesley-hover': number_choose && Data.SelectGroupData.length > 3 == 3 }"
...
export default {
  ...
  methods: {
    ...
    handleAllPumpsClick() {
      ...
      var PumpsNumber;
      var that = this;
      this.$data.number_choose == 4
        ? (PumpsNumber = this.$data.number_input)
        : (PumpsNumber = this.$data.number_choose);
      this.$data.Pumping = true;
      this.$data.Pump_NeedEnd = false;
      this.$data.Pump_number = PumpsNumber;
      var a = this.StartPumpingUsers(!this.$data.animation_switch, 1, this.$data.Data.TotalData, PumpsNumber)
        .then(function (e) {
      ...
      useRequest({
        ...
        success: function (res) {
          ...
          if (RES.errcode == 0) {
            ...
            that.$data.transfer.data.sort((a, b) => {
